          ...
          <v-col cols="8" class="d-flex"> -->
              <div class="d-flex">
                ...
                <v-btn variant="outlined" color="gray" class=" rounded-xl px-4 filter-btn ml-1"
                  style="max-width: 89px !important;min-width:77px !important;height: 40px !important;font-size: 12px;font-weight: 400;border-radius: 42px !important;padding-left: 12px !important;">وصول
                  شده</v-btn>
              </div>
            </div>
          </v-col>
