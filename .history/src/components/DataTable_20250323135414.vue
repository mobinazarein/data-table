      ...
      <v-col cols="12" class="d-flex align-center flex-no-wrap">
        <v-row no-gutters>
          ...
          <v-col cols="8" class="d-flex">
            <v-btn variant="outlined" color="gray" class="rounded-lg ml-1 filter-btn">همه</v-btn>
            <v-btn variant="outlined" color="gray" class="ml-1 rounded-lg filter-btn">ابطال شده</v-btn>
            <v-btn variant="outlined" color="gray" class="ml-2 rounded-lg filter-btn">وصول شده</v-btn>
