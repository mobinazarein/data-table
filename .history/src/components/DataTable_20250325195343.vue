  ...
  <v-container fluid>
    ...
    <v-row class="align-center d-flex d-md-none flex-no-wrap justify-between ">
      <v-col cols="12" class="d-flex align-center flex-no-wrap">
        <v-row no-gutters>
          <v-col cols="4">
            <h2 class="text-nowrap mt-2" style="font-size: 18px; font-weight: 700;">سوابق فیش</h2>
          </v-col>
          <v-col cols="8" class="d-flex">
            <v-btn variant="outlined"
              style="max-width: 44px !important;height: 40px !important;font-size: 12px;font-weight: 400;border-radius: 62px !important;"
              color="gray" class="rounded-xl ml-2 filter-btn">همه</v-btn>
            <v-btn variant="outlined"
              style="max-width: 74px !important;height: 40px !important;font-size: 12px;font-weight: 400;border-radius: 42px !important;padding:0px 12px !important;"
            ...
            <v-btn variant="outlined" color="gray" class=" rounded-xl filter-btn ml-1"
              style="max-width: 77px !important;height: 40px !important;font-size: 12px;font-weight: 400;border-radius: 42px !important;padding-left: 12px !important;">وصول
              شده</v-btn>
          </v-col>
        </v-row>
      </v-col>
