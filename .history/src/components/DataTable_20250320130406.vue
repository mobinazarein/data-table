<template>
  <v-container fluid>
    ...
    <!-- mobile-->
    <v-row class="align-center d-flex d-md-none flex-no-wrap justify-between px-3">
      <v-col cols="auto" class="d-flex align-center flex-no-wrap">
        <h2 class="text-nowrap ml-2" style="font-size: 14px; font-weight: 700;">سوابق فیش</h2>
        ...
        <v-btn variant="outlined"
          style="width: 74px !important;height: 40px !important;font-size: 12px;font-weight: 400;padding-right: 12px;padding-left: 12px;"
          color="gray" class="ml-2 rounded-xl filter-btn">ابطال شده</v-btn>
        <v-btn variant="outlined" color="gray" class=" rounded-xl filter-btn"
          style="width: 77px !important;height: 40px !important;font-size: 12px;font-weight: 400;padding: 8px !important;">وصول
          شده</v-btn>
      </v-col>
      <v-col cols="12" class="d-flex justify-center gap-2 mt-2 flex-wrap">
        <PaginationIcon class="mx-1" />
        <EyeIcon class="mx-1" />
        <InvoiceIcon class="mx-1" />
        <CircleCross class="mx-1" />
        <FilterIcon class="mx-1" />
        <PrinterIcon iconColor="#767E8A" class="mx-1" />
        <ExcelIcon iconColor="#767E8A" class="mx-1" />
      </v-col>
      <v-col cols="12">
