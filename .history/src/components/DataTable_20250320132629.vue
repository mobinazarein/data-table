<template>
  <v-container fluid>
    ...
    <v-row no-gutters>
      <v-col cols="12" md="12">
        <v-data-table :headers="pageDate.headers" :items="pageDate.items"></v-data-table>
      </v-col>
    </v-row>
    <!-- mobile-->
...
const pageDate = ref({
  headers: [
    { title: 'ردیف محاسبه', value: 'row', align: 'center', sortable: true },
    { title: 'شماره سند', value: 'row', align: 'center', sortable: true },
    { title: 'وصول فیش', value: 'row', align: 'center', sortable: true },
    { title: 'تاریخ محاسبه', value: 'row', align: 'center', sortable: true },
    { title: 'مبلغ', value: 'row', align: 'center', sortable: true },
    { title: 'مدت زمان', value: 'row', align: 'center', sortable: true },
    { title: 'تاریخ تسویه', value: 'row', align: 'center', sortable: true },
    { title: 'کاربر محاسب', value: 'row', align: 'center', sortable: true },
    { title: 'نوع فیش', value: 'row', align: 'center', sortable: true },
  ],
  items: [
    { title: 'lfdkh', value: 'row' }
  ]
}).value
</script>
