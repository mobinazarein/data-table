<template>
  <v-container fluid>
    ...
    <!-- mobile -->
    <v-row class="align-center d-flex d-md-none flex-wrap px-3">
      <v-col cols="12" class="d-flex align-center flex-wrap justify-center">
        <h2 class="text-nowrap" style="font-size: 15px; margin-left: 10px;">سوابق فیش</h2>
        <v-btn variant="outlined" color="gray" class="rounded-lg filter-btn"
          style="margin-left: 5px; padding: 0 15px; height: 32px;">وصول شده</v-btn>
        <v-btn variant="outlined" color="gray" class="rounded-lg filter-btn"
          style="margin-left: 5px; padding: 0 15px; height: 32px;">ابطال شده</v-btn>
        <v-btn variant="outlined" color="primary" class="rounded-lg filter-btn"
          style="margin-left: 5px; padding: 0 15px; height: 32px;">همه</v-btn>
      </v-col>
