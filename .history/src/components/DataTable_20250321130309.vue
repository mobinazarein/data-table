  ...
  <v-container fluid>
    ...
    <v-row no-gutters>
      <v-col cols="12" md="12" class="mt-5">
        ...
        <v-row class="justify-space-between align-center px-4 mt-8 ">
          <div class="d-flex align-center ">
      ...
      <v-col cols="12" md="12" class="mt-5">
        ...
        <v-row class="justify-space-between align-center px-4 mt-8 ">
          <div class="d-flex justify-space-between">
            <div class="d-flex align-center ">
              <p style="font-weight: 12px;">نمایش در هر صفحه</p>
              <v-select v-model="itemsPerPage" style="max-width:  50px !important;" :items="[10, 20, 50]"
                density="compact" variant="outlined" rounded="pill" class=" mr-3" hide-details></v-select>
            </div>
            <div class="footer-middle">
              <span class="footer-text"> {{ startIndex }} - {{ endIndex }} از {{ totalItems }} مورد </span>
            </div>
