        ...
        <v-row no-gutters>
          ...
          <v-col cols="8" class="d-flex"> -->
              <div class="d-flex">
                ...
                <v-btn variant="outlined"
                  style="max-width: 77px !important;min-width:74px !important;height: 40px !important;font-size: 12px;font-weight: 400;border-radius: 42px !important;padding:0px 12px !important;"
