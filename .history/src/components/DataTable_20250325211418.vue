<template>
  <v-container fluid>
    ...
    <v-row class="align-center py-3 px-1 d-none d-md-flex" no-gutters>
      ...
      <v-col cols="auto" md="2" class="d-flex align-center justify-end" v-if="showExportButtons">
    ...
    <v-row class="justify-space-between d-md-none align-center px-1 mt-8 ">
      <div class="d-flex align-center ">
        ...
        <v-select v-model="props.itemsPerPage" :items="[10, 20, 50]" density="compact" variant="outlined" rounded="pill"
