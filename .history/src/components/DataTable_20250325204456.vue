    ...
    <v-row class="align-center py-3 px-1 d-none d-md-flex" no-gutters>
      ...
      <v-col cols="auto" class="d-flex align-center mx-auto"> -->
          <v-btn variant="outlined" color="gray" class="rounded-lg ml-2 filter-btn"
            style="max-width: 48px;min-width: 48px;font-size: 14px;">همه</v-btn>
          <v-btn variant="outlined" color="gray" class="ml-2 rounded-lg filter-btn"
            style="max-width: 83px;min-width: 48px;font-size: 14px;">ابطال شده</v-btn>
          <v-btn variant="outlined" color="gray" class="ml-2 rounded-lg filter-btn px-3"
            style="max-width: 86px;min-width: 48px;font-size: 14px;">وصول شده</v-btn>
        </div>
      </v-col>
