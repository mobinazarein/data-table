      ...
      <v-col cols="12" class="d-flex align-center flex-no-wrap">
        <v-row no-gutters>
          ...
          <v-col cols="8" class="d-flex">
            ...
            <v-btn variant="outlined"
              style="width: 74px !important;height: 40px !important;font-size: 12px;font-weight: 400;border-radius: 42px !important;"
            ...
            <v-btn variant="outlined" color="gray" class=" rounded-xl filter-btn ml-1"
              style="width: 77px !important;height: 40px !important;font-size: 12px;font-weight: 400;border-radius: 42px !important;">وصول
              شده</v-btn>
          </v-col>
        </v-row>
      </v-col>
