...
const pageData = ref({
  headers: [
    ...
    { title: 'شماره سند', key: 'documentNumber', align: 'center', sortable: true, width: '121px' },
    { title: 'وصول فیش', key: 'receiptStatus', align: 'center', sortable: true },
    { title: 'تاریخ محاسبه', key: 'calculationDate', align: 'center', sortable: true, width: '139px' },
