<template>
  <v-container fluid>
    ...
    <v-row no-gutters class="py-3 px-5">
    ...
    <v-row class="justify-space-between d-md-none align-center  mt-8 py-3 px-5">
      <div class="d-flex align-center ">
    ...
    <v-row class="justify-space-between d-none d-md-flex align-center py-3 px-5 mt-8">
      <div class="d-flex align-center ">
        <p class="footer-text">نمایش در هر صفحه</p>
        <v-select v-model="itemsPerPage" :items="[10, 20, 50]" density="compact" variant="outlined" rounded="pill"
          class="custom-select mr-3" hide-details></v-select>
