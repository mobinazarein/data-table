  ...
  <v-container fluid>
    ...
    <v-row no-gutters>
      <v-col cols="12" md="12" class="mt-5">
        ...
        <v-row class="justify-space-between align-center px-4 mt-4 custom-footer">
          <div class="d-flex align-center footer-left">
...
const totalItems = ref(190); // تنظیم تعداد کل آیتم‌ها مطابق تصویر
