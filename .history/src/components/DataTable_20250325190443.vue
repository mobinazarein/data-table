  ...
  <v-container fluid>
    ...
    <v-row class="align-center py-3 px-5 d-none d-md-flex" no-gutters>
      ...
      <v-col cols="auto" class="d-flex align-center">
        <v-btn icon variant="flat" style="  background: linear-gradient(45deg, #3FA2ED, #1859BD) !important;
  color: white !important;" class="ml-2 btn-square">
          <PrinterIcon />
        </v-btn>
        <v-btn icon variant="flat" style="  background: linear-gradient(45deg, #02A357, #1859BD) !important;
  color: white !important;" class="btn-square">
          <ExcelIcon />
        </v-btn>
      </v-col>
    </v-row>
    ...
    <v-row class="align-center d-flex d-md-none flex-no-wrap justify-between ">
      ...
      <v-col cols="12" class="d-flex justify-center gap-10 mt-2 flex-wrap">
        <PaginationIcon class="mx-1" />
        <EyeIcon class="mx-1" />
        <InvoiceIcon class="mx-1" />
        ...
        <ExcelIcon iconColor="#767E8A" class="mx-1 mt-3 mr-3" />
      </v-col>
      <v-col cols="12">
