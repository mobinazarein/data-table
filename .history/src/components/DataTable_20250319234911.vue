  ...
  <v-container fluid>
    ...
    <v-row class="align-center py-3 px-5 d-flex d-md-none flex-column">
      <v-col cols="12" class="d-flex align-center justify-between">
        <h2 class="mr-3">سوابق فیش</h2>
        <div class="d-flex">
          <v-btn variant="outlined" color="gray" class="rounded-lg ml-2 mobileSize-btn">همه</v-btn>
          <v-btn variant="outlined" color="gray" class="ml-2 rounded-lg mobileSize-btn">ابطال شده</v-btn>
          <v-btn variant="outlined" color="gray" class="ml-2 rounded-lg mobileSize-btn">وصول شده</v-btn>
        </div>
      </v-col>
