    ...
    <v-row class="align-center py-3 px-1 d-none d-md-flex" no-gutters>
      <v-col cols="12" md="10" class="d-flex align-center  justify-start">
        <div class="d-flex align-center gap-24 justify-start">
          ...
          <div v-for="(icon,index)in iconList :key=" index"> </div></template>
<v-text-field v-if="showSearchBtn" variant="outlined" density="compact" hide-details class="custom-text-field mx-2"
  label="جستجو کنید..." prepend-inner-icon="mdi-magnify" width="295.6875px" />
...
<v-row class="align-center d-flex d-md-none flex-no-wrap justify-between ">
  ...
  <v-col cols="12" class="d-flex justify-center">
    <div class="d-flex flex-column ">
      ...
      <v-text-field width="341px" variant="outlined" hide-details class="custom-text-field mx-2" label="جستجو کنید..."
