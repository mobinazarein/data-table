<template>
  <v-container fluid>
    ...
    <!-- mobile-->
    <v-row class="align-center  d-flex d-md-none flex-column">
      <v-col cols="12" class="d-flex align-center justify-between">
        <h2 class="mr-1 ml-1 text-nowrap d-flex align-center" style="font-size: 15px;">سوابق فیش</h2>
        <div class="d-flex mr-3">
          <v-btn variant="outlined" color="gray" class="rounded-lg ml-2 filter-btn" rounded="xl">همه</v-btn>
          <v-btn variant="outlined" color="gray" class="ml-2 rounded-lg filter-btn" rounded="xl">ابطال شده</v-btn>
          <v-btn variant="outlined" color="gray" class=" rounded-lg filter-btn" rounded="xl">وصول شده</v-btn>
        </div>
      </v-col>
      <v-col cols="12" class="d-flex justify-center gap-10 ">
        <PaginationIcon class="mx-1" />
        <EyeIcon class="mx-1" />
        <InvoiceIcon class="mx-1 ml-2" />
        <CircleCross class="mx-1 mt-3 ml-2" />
        <FilterIcon class="mx-1 mt-3 ml-2" />
        <PrinterIcon iconColor="#767E8A" class="mx-1 mt-3 ml-2" />
        <ExcelIcon iconColor="#767E8A" class="mx-1 mt-3 ml-2" />
      </v-col>
      <v-col cols="12">
        <v-text-field variant="outlined" density="compact" hide-details class="custom-text-field mx-2"
          label="جستجو کنید..." prepend-inner-icon="mdi-magnify" />
