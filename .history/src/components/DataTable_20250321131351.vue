  ...
  <v-container fluid>
    ...
    <v-row no-gutters>
      <v-col cols="12" md="12" class="mt-5">
        ...
        <v-row class="justify-space-between align-center px-4 mt-8 flex-wrap" no-gutters>
          <!-- نمایش در هر صفحه + v-select -->
          <v-col cols="12" md="auto" class="d-flex align-center justify-md-start justify-space-between">
            ...
            <v-select v-model="itemsPerPage" :items="[10, 20, 50]" density="compact" variant="outlined" rounded="pill"
              class="custom-select mx-2" hide-details></v-select>
          </v-col>
          ...
          <!-- نمایش تعداد آیتم‌ها -->
          <v-col cols="12" md="auto" class="d-flex justify-md-end justify-space-between align-center mt-2 mt-md-0">
