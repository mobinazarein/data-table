  ...
  <v-container fluid>
    <v-row class="align-center py-3 px-5" no-gutters>
      ...
      <v-col cols="auto" class="d-flex align-center mx-auto">
        ...
        <v-btn variant="outlined" color="gray" width="83" height="40px" class="ml-2 rounded-lg filter-btn">ابطال
          شده</v-btn>
        <v-btn variant="outlined" color="gray" class="ml-2 rounded-lg filter-btn">وصل شده</v-btn>
      </v-col>
