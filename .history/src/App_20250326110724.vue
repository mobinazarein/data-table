    ...
    <v-locale-provider :rtl="true">
      <div dir="rtl">
        <DataTable :headers="pageData.headers" :items="pageData.items" :showExportButtons="true" :itemsPerPage="20"
          ...
          :iconList="[PaginationIcon, EyeIcon, InvoiceIcon, CircleCross, FilterIcon]" :mobileIconList="[EyeIcon
InvoiceIcon
CircleCross
FilterIcon
PrinterIcon
...
FilterIcon
PrinterIcon
ExcelIcon]" :buttons="pageData.buttonList" :mobileFilterButtons="pageData.mobileBtn" />
      </div>
    </v-locale-provider>
  </v-app>
</template>
