    ...
    <v-locale-provider :rtl="true">
      <div dir="rtl">
        <DataTable :headers="pageData.headers" :items="pageData.items" :showExportButtons="true" :itemsPerPage="20"
          ...
          :iconList="[PaginationIcon, EyeIcon, InvoiceIcon, CircleCross, FilterIcon]" :buttons="pageData.buttonList"
          :mobileFilterButtons="pageData.mobileBtn" />
      </div>
    </v-locale-provider>
  </v-app>
</template>
...
const pageData = ref({
  ...
  mobileBtn: [
    { label: "همه", minWidth: '44px', maxWidth: '44px', borderRadius: '62px' },
